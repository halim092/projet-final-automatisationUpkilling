...
public class PIMEmployeeListPage {
    ...
    private By title = By.cssSelector("h6.orangehrm-main-title[data-v-b6d78ace]");
    ...
    public String getTitleText() {
        ...
        WebElement titleWebElement = wait.until(ExpectedConditions.presenceOfElementLocated(title));
        String TitleText = titleWebElement.getText();
        log.info("Profile text: " + TitleText);
        return TitleText;
    }
}
